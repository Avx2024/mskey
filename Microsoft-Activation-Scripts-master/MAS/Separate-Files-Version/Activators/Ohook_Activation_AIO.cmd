...
echo:
echo                 [1] Install Product Key xxxxx-xxxxx-xxxxx-xxxxx-xxxxx
echo:
...
if defined ohub call :dk_color %Gray% "Office apps such as Word, Excel are activated, use them directly."
echo Help: %mas%troubleshoot
) else (
...
set fixes=%fixes% %mas%troubleshoot
call :dk_color2 %Blue% "IT - " %_Yellow% " %mas%"
)
